...
CP Tree is a command-line tool to generate a directory tree diagram.

## Run the App

To run **CP Tree**, you need to download the source code. Then open a terminal or command-line window and run the following steps:
